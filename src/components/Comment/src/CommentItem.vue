<template>
  <div class="max-w-full mt-5">
    <div class="flex space-x-3 xl:space-x-5">
      ...
      <div class="space-y-5 max-w-full-calc">
        <div class="relative p-4 bg-white rounded-md shadow-md text-primary reply" style="width: fit-content">
          <p class="commentContent" v-html="comment.commentContent.replaceAll('\n', '<br>')" />
          <div class="flex justify-between mt-3 space-x-3 text-xs text-gray-400 md:space-x-16">

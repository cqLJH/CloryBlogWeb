<template>
  <div class="absolute right-0 flex flex-row header-controls top-10" @keydown.k="handleOpenModel" tabindex="0">
    <span class="ob-drop-shadow" data-dia="search" @click="handleOpenModel">
      <svg-icon icon-class="search" />
    </span>
    <Dropdown v-if="multiLanguage" @command="handleClick">
      ...
      <Dropdown hover>
        <span class="mr-2">
          <div class="flex-shrink-0">
            <div class="overflow-hidden rounded-full ring-gray-100 shaodw-lg w-9">
  ...
  <el-dialog v-model="loginDialogVisible" width="30%" :fullscreen="isMobile">
    <el-form @keyup.enter.native="login">
      ...
      <div class="mt-8">
        ...
        <span class="float-right text" @click="openForgetPasswordDialog">忘记密码?</span>
      </div>
    </el-form>
  </el-dialog>
